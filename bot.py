...
async def poll_loop() -> None:
    # This wrapper lets us reload poll interval dynamically.
    await poll_once()
...
async def poll_once() -> None:
    ...
    # Seed on first run to avoid flooding.
    ...
    # Map job_id -> kind for correct embed field.
...
def main() -> None:
    ...
    # Guard: make sure config exists so startup errors are obvious.
